...
.. workshop-speakers::
   ...
   .. workshop-speaker::
      ...
      :image: wei.jpeg
      :title: Assistant Professor
      :affiliation: Department of Psychological & Brain Sciences, Indiana University
...
.. workshop-speakers::
   :template: _templates/v2/speaker_template.html
   :title: Organizers
   :subtitle: Our workshop organizers
...
.. carousel::
   ...
   .. carousel-item::
      ...
      :description: Intuitive graphical interface for advanced visualization and analysis
...
.. workshop-schedule::
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         :time: 13:00 - 13:50
         :title: Intro to Neuroanatomy
         :info: Foundational introduction to computational neuroanatomy concepts for diffusion MRI workflows.
         :speaker: Wei Tang
         :image: wei.jpeg
      ...
      .. workshop-timeline-item::
         ...
         :info: Two-hour hands-on session applying preprocessing techniques learned in the morning sessions with expert guidance.
         :speaker: DIPY Team
         :image: dipy-all.svg
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         :time: 13:00 - 15:00
         :title: Guided Practice
         :info: Two-hour hands-on implementation of reconstruction algorithms with real diffusion MRI datasets and parameter optimization.
         :speaker: DIPY Team
         :image: dipy-all.svg
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         ...
         :info: Accelerating tractography computations using GPU technology for faster processing of large cohorts.
         :speaker: Ariel Rokem
         :image: rokem.jpg
      ...
      .. workshop-timeline-item::
         :time: 14:00 - 16:00
         :title: Guided Practice
         :info: Two-hour practical tractography session generating fiber bundles and visualizing white matter pathways.
         :speaker: DIPY Team
         :image: dipy-all.svg
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         :time: 13:00 - 15:00
         :title: Guided Practice
         :info: Two-hour hands-on tractometry analysis extracting and analyzing diffusion metrics along major white matter pathways.
         :speaker: DIPY Team
         :image: dipy-all.svg
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         :time: 10:00 - 10:50
         :title: Cardiac Diffusion Weighted Imaging: Robust fitting, Constrained fitting, and Uncertainty Quantification methods for DTI, DKI, and QTI
         :info: Practical comparison of robust and constrained fitting strategies, and how uncertainty quantification improves reliability assessment in cardiac DWI.
         :speaker: Sam Coveney
         :image: sam_cov.png
      ...
      .. workshop-timeline-item::
         ...
         :speaker: Maharshi Gor and Mohamed Abouagour
         :image: maharshi.jpeg
      ...
      .. workshop-timeline-item::
         :time: 13:00 - 15:00
         :title: Guided Practice
         :info: Final two-hour hands-on session integrating all learned techniques into a complete analysis pipeline.
         :speaker: DIPY Team
         :image: dipy-all.svg

      .. workshop-timeline-item::
         :time: 15:00 - 15:50
         :title: Round Table: AI Paper Discussion
         :info: Group discussion on selected AI papers, methods, and implications for diffusion MRI analysis.
         :speaker: Everyone
         :image: dipy-all.svg
