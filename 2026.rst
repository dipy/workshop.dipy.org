...
.. workshop-speakers::
   :template: _templates/v2/speaker_template.html
   :title: Conference Managers
   :subtitle: Our workshop conference management team
...
.. workshop-schedule::
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         :time: 10:00 - 10:50
         :title: BundleWarp
         :info: Nonrigid registration for bundles to assist statistical analysis with harmonization.
         :speaker: Bramsh Qamar Chandio
         :image: Chandio.jpeg
   ...
   .. workshop-timeline::
      ...
      .. workshop-timeline-item::
         :time: 10:00 - 10:50
         :title: Cardiac Diffusion Weighted Imaging
         :info: Robust fitting, Constrained fitting, and Uncertainty Quantification methods for DTI, DKI, and QTI
         :speaker: Sam Coveney
         :image: sam_cov.png
