...
class AboutDirective(SphinxDirective):
    ...
    def run(self):
        ...
        # Heading - Add title directly to section
        title = nodes.title(text="About the workshop")
        ...
        watermark_wrapper['classes'] += [
            'flex-col-c-m', 'pos-absolute', 'watermark-wrapper'
        ]
        ...
        p5 = nodes.paragraph(
            text="– DIPY Team!",
            classes=['s2-txt2', 'txt-right', 'p-t-20']
        )
